  ...
  return (
    <div className="mx-auto max-w-7xl pb-8">
      ...
      {(showProductForm || showPublicationForm) && <Card className="mb-6 border-blue-200">
        ...
        {showProductForm ? <form noValidate onSubmit={saveProduct} className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        </form> : <form noValidate onSubmit={savePublication} className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
